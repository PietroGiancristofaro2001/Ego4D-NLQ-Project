...
def read_command_line():
    ...
    # Add the argument for the model type choice VSLnet/VSLbase
    parser.add_argument('--model_type', type=str, default='vslnet', choices=['vslnet', 'vslbase'],
                        help='Type of model variant to use: vslnet (with QGH) or vslbase (no QGH).')
    #Add the argument for save the model checkpoint for fine-tuning
    parser.add_argument(
