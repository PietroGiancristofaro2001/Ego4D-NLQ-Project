...
#download directly in data_gen.py 
nltk.download('punkt_tab')
# Standard path of NLTK data in Google Colab
nltk_colab_data_path = '/root/nltk_data'
#check if exist and in case manually create it
if os.path.exists(nltk_colab_data_path) and nltk_colab_data_path not in nltk.data.path:
    print(f"INFO (da data_gen.py): Aggiunta manuale del percorso dati NLTK: {nltk_colab_data_path}")
    nltk.data.path.append(nltk_colab_data_path)
